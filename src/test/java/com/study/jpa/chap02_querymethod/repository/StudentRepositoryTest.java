...
class StudentRepositoryTest {
    ...
    @Test
    @DisplayName("findByCityAndMajorTest")
    ...
    @Test
    @DisplayName("findByCityAndMajorContainingTest")
    void findByCityAndMajorContainingTest() {
    ...
    void nativeSQLTEST() {
        ...
        //when
        Student student = studentRepository.findOneWithSQL(name);
    ...
    @Test
    @DisplayName("findCityWithJPQLTEST")
    void findCityWithJPQLTEST() {
    ...
    @Test
    @DisplayName("searchByNameJPQLTest")
    void searchByNameJPQLTest() {
        // given
        String name = "춘";
    ...
    @Test
    @DisplayName("deleteWithJPQLTest")
